 ...
 */
export const getContactsCollectionRef = (userId: string) => {
  if (!userId) {
 ...
 */
export const getContactDocRef = (userId: string, contactId: string) => {
  if (!userId || !contactId) {
...
export const getContacts = getTrustedContacts;
export const addContact = addTrustedContact;
export const updateContact = updateTrustedContact;
export const deleteContact = deleteTrustedContact;
